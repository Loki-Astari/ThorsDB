#ifndef THORSANVIL_DB_MYSQL_DETAILS_PACKAGE_RESP_PACKAGE_AUTH_SWITCH_REQUEST_H
#define THORSANVIL_DB_MYSQL_DETAILS_PACKAGE_RESP_PACKAGE_AUTH_SWITCH_REQUEST_H
...
class RespPackageAuthSwitchRequest: public RespPackage
{
    ...
    public:
        ...
        virtual  std::ostream& print(std::ostream& s) const
        {
            ...
            {
                s << "0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<unsigned int>(c) << " ";
            }
            s << ") " << std::dec;
            return s;
        }
