...
template<> inline long          readParameterValue<MYSQL_TYPE_DECIMAL,      long>(ConectReader& p)               {return boost::lexical_cast<long>(p.lengthEncodedString());}
template<> inline long          readParameterValue<MYSQL_TYPE_NEWDECIMAL,   long>(ConectReader& p)               {return boost::lexical_cast<long>(p.lengthEncodedString());}
...
template<> inline int           readParameterValue<MYSQL_TYPE_DECIMAL,      int>(ConectReader& p)                {return boost::lexical_cast<int>(p.lengthEncodedString());}
template<> inline int           readParameterValue<MYSQL_TYPE_NEWDECIMAL,   int>(ConectReader& p)                {return boost::lexical_cast<int>(p.lengthEncodedString());}
...
template<> inline short         readParameterValue<MYSQL_TYPE_DECIMAL,      short>(ConectReader& p)              {return boost::lexical_cast<short>(p.lengthEncodedString());}
template<> inline short         readParameterValue<MYSQL_TYPE_NEWDECIMAL,   short>(ConectReader& p)              {return boost::lexical_cast<short>(p.lengthEncodedString());}
...
template<> inline char          readParameterValue<MYSQL_TYPE_DECIMAL,      char>(ConectReader& p)               {return boost::lexical_cast<char>(p.lengthEncodedString());}
template<> inline char          readParameterValue<MYSQL_TYPE_NEWDECIMAL,   char>(ConectReader& p)               {return boost::lexical_cast<char>(p.lengthEncodedString());}
