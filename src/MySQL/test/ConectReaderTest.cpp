...
TEST(ConectReaderTest, fixedLengthInteger)
{
    ...
    ASSERT_EQ(8LL * 256 * 256 * 256 * 256 * 256 * 256 * 256
            + 7LL * 256 * 256 * 256 * 256 * 256 * 256
            + 6LL * 256 * 256 * 256 * 256 * 256
            + 5LL * 256 * 256 * 256 * 256
            + 4LL * 256 * 256 * 256
            + 3LL * 256 * 256
            + 2LL * 256
...
TEST(ConectReaderTest, lengthEncodedIntegerFail)
{
    ...
    ASSERT_THROW(reader.lengthEncodedInteger(), ThorsAnvil::Logging::CriticalException);    // FA
    ASSERT_THROW(reader.lengthEncodedInteger(), ThorsAnvil::Logging::CriticalException);    // FB
    ASSERT_THROW(reader.lengthEncodedInteger(), ThorsAnvil::Logging::CriticalException);    // FC
}
...
TEST(ConectReaderTest, readDateIntoTimeBagFail)
{
    ...
    ASSERT_THROW(reader.readDateIntoTimeBag(), ThorsAnvil::Logging::CriticalException);
}
...
TEST(ConectReaderTest, readTimeIntoTimeBagFail)
{
    ...
    ASSERT_THROW(reader.readRelMicro(), ThorsAnvil::Logging::CriticalException);
}
