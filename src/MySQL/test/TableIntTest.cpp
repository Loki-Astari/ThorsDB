...
TEST(TableIntTest, ReadUTinyIntoSChar)     { typeBadTest<signed char,    ThorsAnvil::Logging::LogicalException>("SELECT U2 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUTinyIntoSShort)    { typeBadTest<signed short,   ThorsAnvil::Logging::LogicalException>("SELECT U2 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUTinyIntoSInt)      { typeBadTest<signed int,     ThorsAnvil::Logging::LogicalException>("SELECT U2 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUTinyIntoSLong)     { typeBadTest<signed long,    ThorsAnvil::Logging::LogicalException>("SELECT U2 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUTinyIntoSLongLong) { typeBadTest<signed long long,ThorsAnvil::Logging::LogicalException>("SELECT U2 FROM IntTypes where Id=1"); }

// Tiny (-128->127) Values can only be read into "unsigned integer types"
TEST(TableIntTest, ReadTinyIntoUChar)      { typeBadTest<unsigned char,  ThorsAnvil::Logging::LogicalException>("SELECT I2 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadTinyIntoUShort)     { typeBadTest<unsigned short, ThorsAnvil::Logging::LogicalException>("SELECT I2 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadTinyIntoUInt)       { typeBadTest<unsigned int,   ThorsAnvil::Logging::LogicalException>("SELECT I2 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadTinyIntoULong)      { typeBadTest<unsigned long,  ThorsAnvil::Logging::LogicalException>("SELECT I2 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadTinyIntoULongLong)  { typeBadTest<unsigned long long,ThorsAnvil::Logging::LogicalException>("SELECT I2 FROM IntTypes where Id=1"); }
...
TEST(TableIntTest, ReadUSmallIntoUChar)    { typeBadTest<unsigned char,  ThorsAnvil::Logging::LogicalException>("SELECT U3 FROM IntTypes where Id=1"); }
...
TEST(TableIntTest, ReadUSmallIntoChar)     { typeBadTest<char,           ThorsAnvil::Logging::LogicalException>("SELECT U3 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUSmallIntoSChar)    { typeBadTest<signed char,    ThorsAnvil::Logging::LogicalException>("SELECT U3 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUSmallIntoSShort)   { typeBadTest<signed short,   ThorsAnvil::Logging::LogicalException>("SELECT U3 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUSmallIntoSInt)     { typeBadTest<signed int,     ThorsAnvil::Logging::LogicalException>("SELECT U3 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUSmallIntoSLong)    { typeBadTest<signed long,    ThorsAnvil::Logging::LogicalException>("SELECT U3 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUSmallIntoSLongLong){ typeBadTest<signed long long,ThorsAnvil::Logging::LogicalException>("SELECT U3 FROM IntTypes where Id=1"); }

// Small (-32768->32767) Values can only be read into "unsigned integer types"
TEST(TableIntTest, ReadSmallIntoUChar)     { typeBadTest<unsigned char,   ThorsAnvil::Logging::LogicalException>("SELECT I3 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadSmallIntoUShort)    { typeBadTest<unsigned short,  ThorsAnvil::Logging::LogicalException>("SELECT I3 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadSmallIntoUInt)      { typeBadTest<unsigned int,    ThorsAnvil::Logging::LogicalException>("SELECT I3 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadSmallIntoULong)     { typeBadTest<unsigned long,   ThorsAnvil::Logging::LogicalException>("SELECT I3 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadSmallIntoULongLong) { typeBadTest<unsigned long long,ThorsAnvil::Logging::LogicalException>("SELECT I3 FROM IntTypes where Id=1"); }

TEST(TableIntTest, ReadSmallIntoChar)      { typeBadTest<char,            ThorsAnvil::Logging::LogicalException>("SELECT I3 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadSmallIntoSChar)     { typeBadTest<signed char,     ThorsAnvil::Logging::LogicalException>("SELECT I3 FROM IntTypes where Id=1"); }
...
TEST(TableIntTest, ReadUMedIntoUChar)      { typeBadTest<unsigned char,   ThorsAnvil::Logging::LogicalException>("SELECT U4 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUMedIntoUShort)     { typeBadTest<unsigned short,  ThorsAnvil::Logging::LogicalException>("SELECT U4 FROM IntTypes where Id=1"); }
...
TEST(TableIntTest, ReadMedIntoUChar)       { typeBadTest<unsigned char,   ThorsAnvil::Logging::LogicalException>("SELECT I4 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadMedIntoUShort)      { typeBadTest<unsigned short,  ThorsAnvil::Logging::LogicalException>("SELECT I4 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadMedIntoUInt)        { typeBadTest<unsigned int,    ThorsAnvil::Logging::LogicalException>("SELECT I4 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadMedIntoULong)       { typeBadTest<unsigned long,   ThorsAnvil::Logging::LogicalException>("SELECT I4 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadMedIntoULongLong)   { typeBadTest<unsigned long long,ThorsAnvil::Logging::LogicalException>("SELECT I4 FROM IntTypes where Id=1"); }

TEST(TableIntTest, ReadMedIntoChar)        { typeBadTest<char,            ThorsAnvil::Logging::LogicalException>("SELECT I4 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadMedIntoSChar)       { typeBadTest<signed char,     ThorsAnvil::Logging::LogicalException>("SELECT I4 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadMedIntoSShort)      { typeBadTest<signed short,    ThorsAnvil::Logging::LogicalException>("SELECT I4 FROM IntTypes where Id=1"); }
...
TEST(TableIntTest, ReadUIntIntoUChar)      { typeBadTest<unsigned char,   ThorsAnvil::Logging::LogicalException>("SELECT U5 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUIntIntoUShort)     { typeBadTest<unsigned short,  ThorsAnvil::Logging::LogicalException>("SELECT U5 FROM IntTypes where Id=1"); }
...
TEST(TableIntTest, ReadUIntIntoChar)       { typeBadTest<char,            ThorsAnvil::Logging::LogicalException>("SELECT U5 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUIntIntoSChar)      { typeBadTest<signed char,     ThorsAnvil::Logging::LogicalException>("SELECT U5 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUIntIntoSShort)     { typeBadTest<signed short,    ThorsAnvil::Logging::LogicalException>("SELECT U5 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUIntIntoSInt)       { typeBadTest<signed int,      ThorsAnvil::Logging::LogicalException>("SELECT U5 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUIntIntoSLong)      { typeBadTest<signed long,     ThorsAnvil::Logging::LogicalException>("SELECT U5 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUIntIntoSLongLong)  { typeBadTest<signed long long,ThorsAnvil::Logging::LogicalException>("SELECT U5 FROM IntTypes where Id=1"); }

// Int (-2147483648->2147483647) Values can only be read into "unsigned integer types"
TEST(TableIntTest, ReadIntIntoUChar)       { typeBadTest<unsigned char,   ThorsAnvil::Logging::LogicalException>("SELECT I5 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadIntIntoUShort)      { typeBadTest<unsigned short,  ThorsAnvil::Logging::LogicalException>("SELECT I5 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadIntIntoUInt)        { typeBadTest<unsigned int,    ThorsAnvil::Logging::LogicalException>("SELECT I5 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadIntIntoULong)       { typeBadTest<unsigned long,   ThorsAnvil::Logging::LogicalException>("SELECT I5 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadIntIntoULongLong)   { typeBadTest<unsigned long long,ThorsAnvil::Logging::LogicalException>("SELECT I5 FROM IntTypes where Id=1"); }

TEST(TableIntTest, ReadIntIntoChar)        { typeBadTest<char,            ThorsAnvil::Logging::LogicalException>("SELECT I5 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadIntIntoSChar)       { typeBadTest<signed char,     ThorsAnvil::Logging::LogicalException>("SELECT I5 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadIntIntoSShort)      { typeBadTest<signed short,    ThorsAnvil::Logging::LogicalException>("SELECT I5 FROM IntTypes where Id=1"); }
...
TEST(TableIntTest, ReadUNorIntoUChar)      { typeBadTest<unsigned char,   ThorsAnvil::Logging::LogicalException>("SELECT U6 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUNorIntoUShort)     { typeBadTest<unsigned short,  ThorsAnvil::Logging::LogicalException>("SELECT U6 FROM IntTypes where Id=1"); }
...
TEST(TableIntTest, ReadUNorIntoChar)       { typeBadTest<char,            ThorsAnvil::Logging::LogicalException>("SELECT U6 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUNorIntoSChar)      { typeBadTest<signed char,     ThorsAnvil::Logging::LogicalException>("SELECT U6 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUNorIntoSShort)     { typeBadTest<signed short,    ThorsAnvil::Logging::LogicalException>("SELECT U6 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUNorIntoSInt)       { typeBadTest<signed int,      ThorsAnvil::Logging::LogicalException>("SELECT U6 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUNorIntoSLong)      { typeBadTest<signed long,     ThorsAnvil::Logging::LogicalException>("SELECT U6 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUNorIntoSLongLong)  { typeBadTest<signed long long,ThorsAnvil::Logging::LogicalException>("SELECT U6 FROM IntTypes where Id=1"); }

// Nor (-2147483648->2147483647) Values can only be read into "unsigned integer types"
TEST(TableIntTest, ReadNorIntoUChar)       { typeBadTest<unsigned char,   ThorsAnvil::Logging::LogicalException>("SELECT I6 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadNorIntoUShort)      { typeBadTest<unsigned short,  ThorsAnvil::Logging::LogicalException>("SELECT I6 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadNorIntoUInt)        { typeBadTest<unsigned int,    ThorsAnvil::Logging::LogicalException>("SELECT I6 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadNorIntoULong)       { typeBadTest<unsigned long,   ThorsAnvil::Logging::LogicalException>("SELECT I6 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadNorIntoULongLong)   { typeBadTest<unsigned long long,ThorsAnvil::Logging::LogicalException>("SELECT I6 FROM IntTypes where Id=1"); }

TEST(TableIntTest, ReadNorIntoChar)        { typeBadTest<char,            ThorsAnvil::Logging::LogicalException>("SELECT I6 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadNorIntoSChar)       { typeBadTest<signed char,     ThorsAnvil::Logging::LogicalException>("SELECT I6 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadNorIntoSShort)      { typeBadTest<signed short,    ThorsAnvil::Logging::LogicalException>("SELECT I6 FROM IntTypes where Id=1"); }
...
TEST(TableIntTest, ReadUBigIntoUChar)      { typeBadTest<unsigned char,   ThorsAnvil::Logging::LogicalException>("SELECT U7 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUBigIntoUShort)     { typeBadTest<unsigned short,  ThorsAnvil::Logging::LogicalException>("SELECT U7 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUBigIntoUInt)       { typeBadTest<unsigned int,    ThorsAnvil::Logging::LogicalException>("SELECT U7 FROM IntTypes where Id=1"); }
...
TEST(TableIntTest, ReadUBigIntoChar)       { typeBadTest<char,            ThorsAnvil::Logging::LogicalException>("SELECT U7 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUBigIntoSChar)      { typeBadTest<signed char,     ThorsAnvil::Logging::LogicalException>("SELECT U7 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUBigIntoSShort)     { typeBadTest<signed short,    ThorsAnvil::Logging::LogicalException>("SELECT U7 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUBigIntoSInt)       { typeBadTest<signed int,      ThorsAnvil::Logging::LogicalException>("SELECT U7 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUBigIntoSLong)      { typeBadTest<signed long,     ThorsAnvil::Logging::LogicalException>("SELECT U7 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadUBigIntoSLongLong)  { typeBadTest<signed long long,ThorsAnvil::Logging::LogicalException>("SELECT U7 FROM IntTypes where Id=1"); }

// Big (-9223372036854775808->9223372036854775807) Values can only be read into "unsigned integer types"
TEST(TableIntTest, ReadBigIntoUChar)       { typeBadTest<unsigned char,   ThorsAnvil::Logging::LogicalException>("SELECT I7 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadBigIntoUShort)      { typeBadTest<unsigned short,  ThorsAnvil::Logging::LogicalException>("SELECT I7 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadBigIntoUInt)        { typeBadTest<unsigned int,    ThorsAnvil::Logging::LogicalException>("SELECT I7 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadBigIntoULong)       { typeBadTest<unsigned long,   ThorsAnvil::Logging::LogicalException>("SELECT I7 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadBigIntoULongLong)   { typeBadTest<unsigned long long,ThorsAnvil::Logging::LogicalException>("SELECT I7 FROM IntTypes where Id=1"); }

TEST(TableIntTest, ReadBigIntoChar)        { typeBadTest<char,            ThorsAnvil::Logging::LogicalException>("SELECT I7 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadBigIntoSChar)       { typeBadTest<signed char,     ThorsAnvil::Logging::LogicalException>("SELECT I7 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadBigIntoSShort)      { typeBadTest<signed short,    ThorsAnvil::Logging::LogicalException>("SELECT I7 FROM IntTypes where Id=1"); }
TEST(TableIntTest, ReadBigIntoSInt)        { typeBadTest<signed int,      ThorsAnvil::Logging::LogicalException>("SELECT I7 FROM IntTypes where Id=1"); }
