...
TEST(TableBitTest, ReadBit12IntoUChar)    { typeBadTest<unsigned char,   std::runtime_error>("SELECT B1 FROM IntTypes where Id=1"); }
...
TEST(TableBitTest, ReadBit24IntoUChar)    { typeBadTest<unsigned char,   std::runtime_error>("SELECT B2 FROM IntTypes where Id=1"); }
TEST(TableBitTest, ReadBit24IntoUShort)   { typeBadTest<unsigned short,  std::runtime_error>("SELECT B2 FROM IntTypes where Id=1"); }
...
TEST(TableBitTest, ReadBit48IntoUChar)    { typeBadTest<unsigned char,   std::runtime_error>("SELECT B3 FROM IntTypes where Id=1"); }
TEST(TableBitTest, ReadBit48IntoUShort)   { typeBadTest<unsigned short,  std::runtime_error>("SELECT B3 FROM IntTypes where Id=1"); }
TEST(TableBitTest, ReadBit48IntoUInt)     { typeBadTest<unsigned int,    std::runtime_error>("SELECT B3 FROM IntTypes where Id=1"); }
