...
{
    User   user{"M1", "P1", 25};
    auto insert = make_CmdDB_Delete("database", "collection", ThorsAnvil::DB::Mongo::QueryOptions{}, user);
...
{
    User   user{"M1", "P1", 25};
    auto insert = make_CmdDB_Delete("database", "collection", ThorsAnvil::DB::Mongo::QueryOptions{}, user).unordered();
...
{
    User   user{"M1", "P1", 25};
    auto insert = make_CmdDB_Delete("database", "collection", ThorsAnvil::DB::Mongo::QueryOptions{}, user).setWrieConcern(2, false, 400);
...
{
    User   user{"M1", "P1", 25};
    auto insert = make_CmdDB_Delete("database", "collection", ThorsAnvil::DB::Mongo::QueryOptions{}, user).unordered().setWrieConcern(2, false, 400);
